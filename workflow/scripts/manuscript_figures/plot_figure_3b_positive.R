...
pdf(snakemake@output[["output_figure_3b_gamma_pos"]], width = 8, height = 8)
...
pdf(snakemake@output[["output_figure_3b_tau_pos"]], width = 8, height = 8)
chordDiagram(gis2[,c(1,2,6)], 
             group = grouping, 
             grid.col = coloring, 
             small.gap = 0, 
...
pdf(snakemake@output[["output_figure_3b_nu_pos"]], width = 8, height = 8)
chordDiagram(gis2[,c(1,2,6)], 
             group = grouping, 
             grid.col = coloring, 
             small.gap = 0, 
...
pdf(snakemake@output[["output_figure_3b_positive_cluster_labels"]], width = 8, height = 8)
chordDiagram(gis2[,c(1,2,6)], 
             group = grouping, 
             grid.col = coloring, 
             small.gap = 0, 
